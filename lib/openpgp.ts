...
@param publicKey - The public key to generate the revocation certificate for.
...
@param name - The name to use for the key owner.
@param email - The email address to use for the key owner.
