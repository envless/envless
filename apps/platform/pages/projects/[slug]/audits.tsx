  ...
  return (
    ...
    >
      <SlideOver
        ...
        size="xl"
        description="Chetan Kharel performed access.created on 29 July 2022, 21:32"
        open={open}
        setOpen={setOpen}
        submitButtonIcon={
        ...
        <div className="flex h-full flex-col">
          <div className="flex-1 overflow-y-auto">
            <div className="divide divide-dark divide-y-2 py-2 px-4 sm:px-6">
              <div className="my-4 grid grid-cols-2 py-4 text-sm">
                <label>Created By</label>
                <div>Chetan Kharel</div>
              </div>

              <div className="my-4 grid grid-cols-2 py-4 text-sm">
                <label>Action Performed</label>
                <div>
                  <span className="border-dark rounded-xl border px-2 py-0.5 font-normal tracking-tight text-emerald-200">
                    access.created
                  </span>
                </div>
              </div>
              ...
              <div className="my-4 grid grid-cols-2 py-4 text-sm">
                ...
                <div>29 July 2022, 9:32 PM</div>
              </div>

              <div className="scrollbar-thin scrollbar-track-dark  scrollbar-thumb-darker h-full overflow-y-scroll rounded-md lg:max-h-64">
                <CopyBlock
        ...
        <table className="w-full table-auto border-b-2 text-left text-sm">
          <thead className="border-dark border-b-2">
            <tr>
              ...
              <th className="py-3 px-6 text-sm font-normal">
                Action Performed
              </th>
            ...
            {auditLogs.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className="whitespace-nowrap rounded-md px-6 py-4">
                  <span className="border-dark rounded-xl border px-2 py-0.5 font-normal uppercase tracking-tight text-emerald-200">
                    {item.action}
                  </span>
                </td>
