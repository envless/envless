      ...
      <div className="flex h-full flex-col">
        <div className="flex-1 overflow-y-auto">
          <div className="divide divide-dark divide-y-2 py-2 px-4 sm:px-6">
            ...
            <div className="py-4">
              <label className="mt-1 text-sm">Data</label>
              <div className="scrollbar-thin scrollbar-track-dark scrollbar-thumb-darker mt-3 h-full h-full overflow-y-scroll rounded-md lg:max-h-64">
                <CopyBlock
