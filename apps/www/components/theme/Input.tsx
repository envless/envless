    ...
    <div className="my-6">
      ...
      <div className="my-2">
        <input
          ...
          onChange={onChange}
          className="bg-dark block w-full appearance-none rounded border border-zinc-700 px-3 py-2 placeholder-gray-500 shadow-sm focus:border-zinc-700 focus:outline-none focus:ring-zinc-700 sm:text-sm"
        />
      </div>
    </div>
  );
