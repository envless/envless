        ...
        <div className="-m-7 flex flex-wrap">
          <div className="w-full p-7 md:w-1/3">
            <div className="h-full">
              ...
              <p className="text-base text-light-50">
          ...
          <div className="w-full p-7 md:w-1/3">
            <div className="h-full rounded border border-dark-900 bg-dark-800 p-8">
              <div className="mb-7 flex flex-wrap justify-between pb-2">
                <div className="w-full xl:w-auto">
                  <h3 className="text-2xl text-light-900">Personal</h3>
                </div>
              </div>
              <ul className="mb-8">
                <li className="font-heading mb-4 flex items-center text-base font-medium text-light-50">
                ...
                <li className="font-heading flex items-center text-base font-medium text-light-50">
                  <Verified className="mr-2 h-6 w-6 text-teal-400" />
                  <p>Deploy anywhere</p>
                </li>
              </ul>
              ...
              >
                <div className="rounded bg-light-900 py-4 px-9 hover:bg-gray-300 ">
          ...
          <div className="w-full p-7 md:w-1/3">
            <div className="h-full rounded p-0.5">
              <div className="rounded bg-light-900 p-8">
                <div className="mb-7 flex flex-wrap justify-between pb-2">
                  <div className="w-full xl:w-auto">
                ...
                <Link
                  href="/auth"
                  target="_self"
                  className="font-heading tracking-px group relative mb-3 w-full overflow-hidden rounded text-center text-xs font-semibold uppercase text-light-50 md:w-auto"
                >
                  <div className="overflow-hidden rounded bg-dark-900 py-4 px-9 hover:bg-dark-700">
