              ...
              <Input
                ...
                validationSchema={{
                  ...
                  pattern: {
                    value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,
                    message:
                      "Password must be minimum 8 characters, composes of small and capital letters, numbers and special characters",
                  },
                }}
                onKeyUp={(e) => {
                  ...
                  if (password.length === 0) {
                    ...
                    const seconds =
                      score.crack_times_seconds.online_throttling_100_per_hour;
                    const humanized = secondsToString(seconds / 60) as string;
